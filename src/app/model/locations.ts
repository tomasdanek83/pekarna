...
export const Locations: Location[] = [
    ...
    },
    {
        ...
        question: 'Lesu, do kterého právě vstupujete, říkáme také „zelený les“. V létě je tu totiž opravdu zeleno, a to hlavně zásluhou zelených korun stromů a šťavnatého travního porostu pod nimi. Dominují zde dva druhy stromů a podle nich se tento typ lesa také nazývá. Věděli byste, jak? (Máte to trochu těžší, protože teď v zimě mají stromy shozené listí.) Odpověď napište jako přídavné jméno.',
        ...
        answer: ['dubohabrový', 'dubo-habrový'],
    ...
    },
    {
        ...
        question: 'Přírodní památka Pekárna, ve které se nacházíte, se rozprostírá na zalesněných svazích nad údolím potoka Vrbovce. Svahy tvoří kopec se třemi výraznějšími vrchy. Vy jste teď dorazili na první z nich, s nadmořskou výškou 306 m n.m. (Pro zajímavost, údolí Vrbovce, ze kterého jste sem vystoupali, je v nadmořské výšce 250 m n.m.) Stejné číslo, jako je nadmořská výška tohoto vrcholu, nese jeden z modelů vozů značky Peugeot. Uhodněte, ve kterém roce se Peugeot 306 naposledy vyráběl, a odpověď napište číslem (máte toleranci +- 2 roky).',
    ...
    },
    {
        ...
        question: 'Na jaře, ještě než na stromech vyraší listí, bývá země v tomto lese pokrytá sasankami, jaterníky, plicníky… Spěchají, protože potřebují stihnout rozvinout své listy a květy, vytvořit semínka a vyrobit si cukr do zásoby dříve, než jim listnaté stromy zastíní zdroj světla. Zkuste odhadnout, kolik procent světla dopadá na zem v listnatém lese v době, kdy už jsou listnaté koruny plně rozvinuté (ve srovnání s místem, kde žádný les neroste). Správnou odpověď napište v rozmezí desítky procent (například 90-100).',
    ...
    },
    {
        ...
        question: 'Jedním z vzácných druhů rostlin, které v Pekárně můžeme najít, je prstnatec bezový. Je to světlomilná rostlina, která roste na suchých, kamenitých, na živiny chudých půdách, na loukách, pastvinách a po okrajích světlých lesů. Kvete v dubnu a v květnu. Vyznačuje se výrazným polymorfismem: její květy jsou buď tmavě nachové, nebo světle žluté. Kříženci obou barevných forem pak mají barvu oranžovou. Jde o rostlinu v české přírodě velmi vzácnou. Věděli byste, do které čeledi patří?',
    ...
    },
    {
        ...
        question: 'Zejména na jižním okraji Pekárny najdeme velké množství malých javůrků, které vynikají na podzim svojí nádhernou žlutou barvou. Zelený les se na chvíli promění ve žlutý les. Zatímco semena některých stromů (dubů nebo buků například) padají přímo pod mateřský strom, a v jeho stínu a za jeho asistence prožívají první roky (no, vlastně spousty let) svého života, semínka jiných stromů (například javorů) jsou lehká a snadno cestují – mají třeba „vrtulku“ nebo chmýří. Dětem těchto stromů žít daleko od rodiny nevadí. Věděli byste, jak se správně nazývá ten druh plodu, který javory mají?',
